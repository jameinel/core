...
import (
	...
	apideployer "github.com/wallyworld/core/state/api/deployer"
	"github.com/wallyworld/core/state/api/params"
	apirsyslog "github.com/wallyworld/core/state/api/rsyslog"
	charmtesting "github.com/wallyworld/core/state/apiserver/charmrevisionupdater/testing"
...
func (s *MachineSuite) TestDyingMachine(c *gc.C) {
	...
	case <-time.After(watcher.Period * 5 / 4):
		...
		// https://bugs.github.com/wallyworld/core/+bug/1163983
